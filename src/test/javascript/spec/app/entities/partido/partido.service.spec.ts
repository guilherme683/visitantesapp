    ...
    describe('Partido Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/partidos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Partido', () => {
                service.create(new Partido(null)).subscribe(received => {
            ...
            it('should update a Partido', () => {
                service.update(new Partido(123)).subscribe(received => {
