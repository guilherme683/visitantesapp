    ...
    describe('Municipios Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/municipios';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Municipios', () => {
                service.create(new Municipios(null)).subscribe(received => {
            ...
            it('should update a Municipios', () => {
                service.update(new Municipios(123)).subscribe(received => {
