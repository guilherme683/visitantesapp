...
describe('Service Tests', () => {
    describe('Cargo Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CargoService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/cargos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Cargo', () => {
                service.create(new Cargo(null)).subscribe(received => {
            ...
            it('should update a Cargo', () => {
                service.update(new Cargo(123)).subscribe(received => {
