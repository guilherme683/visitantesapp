...
describe('Service Tests', () => {
    describe('Visitantes Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(VisitantesService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/visitantes';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Visitantes', () => {
                service.create(new Visitantes(null)).subscribe(received => {
            ...
            it('should update a Visitantes', () => {
                service.update(new Visitantes(123)).subscribe(received => {
