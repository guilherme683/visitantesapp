...
import { VisitantesComponent } from 'app/entities/visitantes/visitantes.component';
...
describe('Component Tests', () => {
    describe('Visitantes Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.visitantes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
