...
export class AcessoresComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.acessoresService
            ...
            .subscribe(
                (res: HttpResponse<IAcessores[]>) => this.paginateAcessores(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/acessores'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    private paginateAcessores(data: IAcessores[], headers: HttpHeaders) {
